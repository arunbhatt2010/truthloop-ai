...
const loadEvidenceCompressionBrain = async ({
  truthLoopPackage = {},
  publicEvidencePackage = {}
} = {}) => {
  ...
  console.log(
    ...
    JSON.stringify({
      ...
      reportChars: investigationReport.report.length,
      ...
      withinLimit: investigationReport.reportBudget.withinLimit,
  ...
  return {
    success: true,
    investigationReport: investigationReport.report,
    sourceRegistry: investigationReport.sourceRegistry,
    loop7Package: {
      packageType: "Loop7InvestigationPackage",
      investigationReport: investigationReport.report,
      sourceRegistry: investigationReport.sourceRegistry
    }
  };
